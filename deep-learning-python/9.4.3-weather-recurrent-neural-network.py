...
# Let's try an RNN now, we will use GRU layers which are LSTM layers that are cheaper to run but less effective.
...
"""
We get a 0.265 MAE which is significantly better than the baseline and previous network.
This is 2.35˚C.
"""
