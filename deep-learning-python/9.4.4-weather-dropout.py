...
# There is still some room for improvement, we will use a dropout layer to fight overfitting.
# The dropout layer we have used would not work with an RNN as it would block the learning process, we will tweak it a bit.
...
# The results are somewhat improving : it does not overfit but the MAE stays the same.
